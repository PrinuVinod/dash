// src/Dashboard.tsx
import CyberKarmaGPT from '../components/cyberkarma/cyberkarmagpt';
import React, { useEffect, useState } from 'react';
import { Box, Typography, Button, GlobalStyles, Divider } from '@mui/material';
...
const Dashboard: React.FC = () => {
  ...
  // Custom Background Component for Double Bar Chart
  const CustomBackground = ({ x, y, width, height, payload }: any) => {
    return (
      <>
        {doubleBarData.map((entry, index) => {
          const groupWidth = width / doubleBarData.length;
          const groupX = x + index * groupWidth;
          return (
            <rect
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Optional: Render content for other buttons like CyberKarma GPT */}
